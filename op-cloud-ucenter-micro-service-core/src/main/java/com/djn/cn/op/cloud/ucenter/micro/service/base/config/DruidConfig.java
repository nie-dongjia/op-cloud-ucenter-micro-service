package com.djn.cn.op.cloud.ucenter.micro.service.base.config;
...
@Configuration
@MapperScan(basePackages= "com.djn.cn.op.cloud.ucenter.micro.service.*.dao" , markerInterface = MyMapper.class)
